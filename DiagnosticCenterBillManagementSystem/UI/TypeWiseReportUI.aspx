<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TypeWiseReportUI.aspx.cs" Inherits="DiagnosticCenterBillManagementSystem.UI.TypeWiseReportUI" %>
                                                ...
                                                <fieldset class="fieldset-1">
                                                    ...
                                                    <fieldset class="fieldset-2">
                                                        <table>
                                                            ...
                                                            <tr>
                                                                <td colspan="3">
                                                                    <asp:Label ID="notificationLabel" runat="server" Font-Bold="True"></asp:Label>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </fieldset>
                                                    <br />
                                                    <br />
                                                    <asp:GridView ID="TypeWiseReportGridView" runat="server" AllowPaging="True" AutoGenerateColumns="False" Width="100%" OnPageIndexChanging="gvDetails_PageIndexChanging" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField="TestTypeName" HeaderText="Test Type Name" />
                                                            <asp:BoundField DataField="TotalNoOfTest" HeaderText="Total No Of Test" />
                                                    ...
                                                    <table align="center">
                                                        <tr>
                                                            <td>
                                                                <asp:Button ID="pdfButton" runat="server" Text="PDF" OnClick="pdfButton_Click" Font-Size="Large" />
                                                            </td>
                                                            <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
